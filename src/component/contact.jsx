        ...
        return (
             ...
             <Rosa animation="zoom-in"   
                 ...
                 <div className="row no-gutters" >
                   <div className="col-md-2 mb-md-0 p-md-4"></div>
                     <div className="col-md-5 col-sm-6 col-xs-6 p-4 pl-md-4 shadow-lg p-3 mb-5 mt-4 bg-dark rounded">
                       ...
                       <h5 style={{padding:"12px"}}><i class="fa fa-comments-o" aria-hidden="true" style={{fontSize:"30px" ,paddingRight:"10px"}}></i>Drop Me a Line</h5>
                       </ScrollAnimation>
                       {/* Contact Form */}
                 ...
                 <div className="col-md-3 col-sm-6 col-xs-6 p-4 pl-md-4 shadow-lg p-3 mb-5 mt-4 bg-dark rounded">
                   <ScrollAnimation animateIn='flipInY'animateOut='flipOutY' style={{textAlign:'center',color:'whitesmoke'}}>
                   <h5 style={{padding:"12px"}}><i class="fa fa-map-marker" aria-hidden="true" style={{fontSize:"30px" ,paddingRight:"10px"}}></i>I'm Here</h5>
                   </ScrollAnimation>
