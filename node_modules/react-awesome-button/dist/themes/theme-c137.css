.aws-btn {
  ...
  --button-primary-color: #444444;
  --button-primary-color-dark: #111111;
  --button-primary-color-light: #f5f7f8;
  --button-primary-color-hover: #1e1e1e;
  --button-primary-color-active: #444444;
  --button-primary-border: none;
  --button-secondary-color: #39afb1cb;
  --button-secondary-color-dark: #232c2c;
  --button-secondary-color-light: #f6f8f8;
  --button-secondary-color-hover: #293b3c;
  --button-secondary-color-active: #444444;
